...
def optimise_flight_schedules():
    aircraft_df, crew_df, flights_df = get_data()
    ...
    print_results(aircraft_df, crew_df, flights_df, prob, x, y)


def print_results(aircraft_df, crew_df, flights_df, prob, x, y):
    ...
    for f in flights_df['flight_id']:
        ...
        if assigned_aircraft:
            fuel_cost_per_hour = \
            aircraft_df.loc[aircraft_df.aircraft_id == assigned_aircraft, 'fuel_cost_per_hour'].values[
                0]
...
def get_data():
    flights_df = pd.DataFrame([
        {"flight_id": "F1", "source": "DEL", "destination": "BOM", "distance_km": 1150, "duration_hr": 4,
         "required_model": "Airbus A320"},
        {"flight_id": "F2", "source": "BOM", "destination": "BLR", "distance_km": 980, "duration_hr": 5,
         "required_model": "Boeing 737"},
        {"flight_id": "F3", "source": "BLR", "destination": "HYD", "distance_km": 500, "duration_hr": 3,
         "required_model": "ATR 72"},
        {"flight_id": "F4", "source": "HYD", "destination": "MAA", "distance_km": 610, "duration_hr": 2,
         "required_model": "Bombardier Q400"},
    ])
    ...
    return aircraft_df, crew_df, flights_df


if __name__ == '__main__':
    optimise_flight_schedules()